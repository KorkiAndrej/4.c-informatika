...
recept1 = Recept("Pasta Carbonara", "Srednja", ["pasta", "jaja", "slanina", "parmezan"], "Skuhajte pastu. U tavi ispržite slaninu. Pomiješajte jaja i parmezan, dodajte u pastu i slaninu.")
recept2 = Recept("Palačinke", "Laka", ["brašno", "jaja", "mlijeko", "šećer"], "Pomiješajte sastojke i ispecite tanke palačinke na tavi.")
